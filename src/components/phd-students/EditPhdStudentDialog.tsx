...
export function EditPhdStudentDialog({ open, onOpenChange, student, studentType, currentAcademicYear }: EditPhdStudentDialogProps) {
  ...
  }, [watchedFirstRegistrationYear, currentAcademicYear, studentType, form, inscriptionStatusAr, inscriptionOptions, manualCurrentYear, manualRegistrationCount]);
  ...
  useEffect(() => {
    if (student) {
      ...
      if (student.first_registration_year && currentAcademicYear) {
        ...
        // Reset manual overrides when student changes
        setManualCurrentYear(null);
        setManualRegistrationCount(null);
      }
    }
