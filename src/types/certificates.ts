...
export const certificateFields: Record<CertificateType, { key: string; name_ar: string; name_fr: string; required: boolean }[]> = {
  phd_lmd: [
    ...
    { key: 'full_name_fr', name_ar: 'الاسم واللقب (فرنسي)', name_fr: 'Nom et Prénom', required: false },
    ...
    { key: 'faculty_fr', name_ar: 'الكلية (فرنسي)', name_fr: 'Faculté', required: false },
    ...
    { key: 'specialty_fr', name_ar: 'التخصص (فرنسي)', name_fr: 'spécialité', required: false },
